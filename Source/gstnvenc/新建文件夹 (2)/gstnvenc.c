...
NVENCSTATUS
GstNvEncOpenEncodeSessionEx (NV_ENC_OPEN_ENCODE_SESSION_EX_PARAMS * params,
    void **encoder)
{
...
NVENCSTATUS
GstNvEncDestroyEncoder (void *encoder)
{
...
NVENCSTATUS
GstNvEncGetEncodeGUIDs (void *encoder, GUID * array, uint32_t array_size,
    uint32_t * count)
{
...
NVENCSTATUS
GstNvEncGetEncodeProfileGUIDCount (void *encoder, GUID encodeGUID,
...
NVENCSTATUS
GstNvEncGetEncodeProfileGUIDs (void *encoder, GUID encodeGUID,
...
NVENCSTATUS
GstNvEncGetInputFormats (void *encoder, GUID enc_guid,
...
NVENCSTATUS
GstNvEncGetEncodePresetConfig (void *encoder, GUID encodeGUID,
...
NVENCSTATUS
GstNvEncGetEncodeCaps (void *encoder, GUID encodeGUID,
...
NVENCSTATUS
GstNvEncGetSequenceParams (void *encoder,
...
NVENCSTATUS
GstNvEncInitializeEncoder (void *encoder, NV_ENC_INITIALIZE_PARAMS * params)
{
...
NVENCSTATUS
GstNvEncReconfigureEncoder (void *encoder, NV_ENC_RECONFIGURE_PARAMS * params)
{
...
NVENCSTATUS
GstNvEncRegisterResource (void *encoder, NV_ENC_REGISTER_RESOURCE * params)
{
...
NVENCSTATUS
GstNvEncUnregisterResource (void *encoder, NV_ENC_REGISTERED_PTR resource)
{
...
NVENCSTATUS
GstNvEncMapInputResource (void *encoder, NV_ENC_MAP_INPUT_RESOURCE * params)
{
...
NVENCSTATUS
GstNvEncUnmapInputResource (void *encoder, NV_ENC_INPUT_PTR input_buffer)
{
...
NVENCSTATUS
GstNvEncCreateInputBuffer (void *encoder, NV_ENC_CREATE_INPUT_BUFFER * input_buf)
{
...
NVENCSTATUS
GstNvEncLockInputBuffer (void *encoder, NV_ENC_LOCK_INPUT_BUFFER * input_buf)
{
...
NVENCSTATUS
GstNvEncUnlockInputBuffer (void *encoder, NV_ENC_INPUT_PTR input_buf)
{
...
NVENCSTATUS
GstNvEncDestroyInputBuffer (void *encoder, NV_ENC_INPUT_PTR input_buf)
{
...
NVENCSTATUS
GstNvEncCreateBitstreamBuffer (void *encoder, NV_ENC_CREATE_BITSTREAM_BUFFER * bb)
{
...
NVENCSTATUS
GstNvEncLockBitstream (void *encoder, NV_ENC_LOCK_BITSTREAM * lock_bs)
{
...
NVENCSTATUS
GstNvEncUnlockBitstream (void *encoder, NV_ENC_OUTPUT_PTR bb)
{
...
NVENCSTATUS
GstNvEncDestroyBitstreamBuffer (void *encoder, NV_ENC_OUTPUT_PTR bit_buf)
{
...
NVENCSTATUS
GstNvEncEncodePicture (void *encoder, NV_ENC_PIC_PARAMS * pic_params)
{
...
gboolean
gst_nv_encoder_plugin_init(GstPlugin * plugin)
{
  ...
  MYPROC nvEncodeAPICreateInstance = (MYPROC)GetProcAddress(hinstLib, "NvEncodeAPICreateInstance");
  if (nvEncodeAPICreateInstance == NULL){
	  GST_ERROR("Failed to get process address");
	  FreeLibrary(hinstLib);
	  return FALSE;
  }
  if (nvEncodeAPICreateInstance(&nvenc_api) != NV_ENC_SUCCESS) {
    ...
    gst_element_register (plugin, "nvenc", GST_RANK_PRIMARY * 2,
